/**
 * Register over de opprinnelige AG-råkortene (DULT-*) med teksten VERBATIM fra
...
const AG_RAAKORT: Record<string, string> = {
  "DULT-01": "Kartlegge behov for oppfølgingsplan",
  "DULT-02":
  ...
  "DULT-12": "Bruke kalenderavtale til evaluering av oppfølgingsplan",
  "DULT-15":
  ...
  "DULT-19": "Utkast lagret kan flyttes opp",
  "DULT-20":
  ...
  "DULT-27":
    "Det burde stå om hvorfor man skal dele planen med fastlege og Nav",
  "DULT-28":
  ...
  "DULT-31": "Ha med en knapp inne på planen «endre/juster/oppdater plan»",
  "DULT-33":
    "Dersom man ikke har behov for en plan kan man her oppgi det, og dele infoen med nav og lege.",
  "DULT-35": "Ikke synlig nok at det er den siste / aktive plan",
};

/** Verbatim råkort-tekst for en DULT-kode, eller undefined hvis ukjent. */
